...
import type { MortgageOfferData } from "../models/mortgage_models";
	...
	return (
		<div className="container contact-form">
			...
			<form onSubmit={handleSubmit}>
				<label>
					<p>Namn:</p>
					<input type="text" name="name" value={formState.name} onChange={handleInputChange} required></input>
				</label>
				<label>
					<p>Adress:</p>
					<input type="text" name="address" value={formState.address} onChange={handleInputChange} required></input>
				</label>
				<label>
					<p>Postnummer:</p>
					<input
				...
				<label>
					<p>Postort:</p>
					<input type="text" name="city" value={formState.city} onChange={handleInputChange} required></input>
				</label>
				<label>
					<p>Telefonnummer:</p>
					<input
				...
				<label>
					<p>Epost:</p>
					<input type="email" name="email" value={formState.email} onChange={handleInputChange} required></input>
				</label>
